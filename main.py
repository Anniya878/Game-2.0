...
def draw():
    ...
    screen.draw.filled_rect(questionbox, (235, 180, 250))
    screen.draw.filled_rect(anwserbox1, (250, 222, 244))
    screen.draw.filled_rect(anwserbox2, (250, 222, 244))
    screen.draw.filled_rect(anwserbox3, (250, 222, 244))
    screen.draw.filled_rect(anwserbox4, (250, 222, 244))
    ...
    screen.draw.textbox("Welcome to a fun Trivia", titlebox, color="white")
